...
declare namespace ApiTypes {
    ...
    export interface AddProblemFileResponseDto {
        error?: "NO_SUCH_PROBLEM" | "PERMISSION_DENIED" | "TOO_MANY_FILES" | "TOTAL_SIZE_TOO_LARGE" | "FILE_UUID_EXISTS" | "FILE_NOT_UPLOADED";
    ...
    export interface GetSessionInfoResponseDto {
        ...
        userPrivileges?: ("EditHomepage" | "ManageUser" | "ManageUserGroup" | "ManageProblem" | "ManageContest" | "ManageDiscussion" | "SkipRecaptcha")[];
    ...
    export interface GetUserMetaResponseDto {
        error?: "NO_SUCH_USER";
        meta?: ApiTypes.UserMetaDto;
        privileges?: ("EditHomepage" | "ManageUser" | "ManageUserGroup" | "ManageProblem" | "ManageContest" | "ManageDiscussion" | "SkipRecaptcha")[];
    }
    ...
    export interface QuerySubmissionRequestDto {
        ...
        submitter: string;
        codeLanguage: string;
        status: "Pending" | "ConfigurationError" | "SystemError" | "Canceled" | "CompilationError" | "FileError" | "RuntimeError" | "TimeLimitExceeded" | "MemoryLimitExceeded" | "OutputLimitExceeded" | "PartiallyCorrect" | "WrongAnswer" | "Accepted" | "JudgementFailed";
        minId: number;
        maxId: number;
        takeCount: number;
    }
    ...
    export interface RemoveUserFromGroupResponseDto {
        error?: "PERMISSION_DENIED" | "NO_SUCH_USER" | "NO_SUCH_GROUP" | "USER_NOT_IN_GROUP" | "GROUP_ADMIN_CAN_NOT_BE_REMOVED";
    }
    ...
    export interface SendEmailVerificationCodeResponseDto {
        error?: "PERMISSION_DENIED" | "DUPLICATE_EMAIL" | "NO_SUCH_USER" | "ALREADY_LOGGEDIN" | "FAILED_TO_SEND" | "RATE_LIMITED";
        errorMessage?: string;
    }
